...
CNodeDivide::CNodeDivide( CNodeView *p ) : BaseClass( "Divide", p )
{
...
CNodeDivide::~CNodeDivide()
{
}

int CNodeDivide::UpdateInputsValid()
{
...
void CNodeDivide::UpdateOutputs()
{
...
bool CNodeDivide::CreateSolvers(GenericShaderData *ShaderData)
{
	...
	CHLSL_Solver_Divide *solver = new CHLSL_Solver_Divide( GetUniqueIndex() );
